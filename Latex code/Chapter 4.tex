...
\textbf{Classifier-Accuracy Testing} (CAT), first explicitly described by Friedman \cite{friedmanCAT}
and later studied in a rigorous minimax framework by Gerber et al.\ \cite{gerberclas}. The central
